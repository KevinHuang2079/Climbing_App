...
function BuildProfile({ userID, username }) {
                    ...
                    <div className="Profile">
                        <div className='User'>
                            ...
                            <div className="FollowSection">
                                <Link to={`/profile/info/${userID}/${username}/followers`} className="followers"> 
                                    Followers
                                </Link>
                                <Link to={`/profile/info/${userID}/${username}/following`} className="following"> 
                                    Following
                                </Link>
                            </div>
                        </div>
